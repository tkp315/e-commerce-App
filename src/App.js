  ...
  return (
    <div>
      <Routes>
        ...
        <Route
          path="/generate-token"
          element={<TokenGenerator></TokenGenerator>}
        ></Route>
        <Route
          path="/reset-password"
        ...
        <Route
          element={
            <RequireAuth allowedRoles={["Customer"]}></RequireAuth>
          }
        >
        ...
        <Route
          element={
            <RequireAuth allowedRoles={["Seller", "Admin"]}></RequireAuth>
          }
        >
          <Route
        ...
        {/* <Route
          path="/allCategory"
          element={<GetAllCategory></GetAllCategory>}
        ></Route> */}
...
<Route
        ...
        >
         <Route path="/user/order/:productId" element={<Placement></Placement>}>
          {" "}
        </Route>
        </Route>
        ...
        >
        <Route
          path="/payment/verify?refrence=/:ref_No"
        ...
        >
          <Route
            path="/subcategory-products/:subCatName"
            element={<ProductBySubCat></ProductBySubCat>}
          >
            {" "}
          </Route>
        </Route>
        ...
        <Route element={<RequireAuth allowedRoles={["Admin"]}></RequireAuth>}>
          <Route
            path="/add-pincode"
            element={<AvailablePinCodes></AvailablePinCodes>}
          >
            {" "}
          </Route>
        </Route>
        ...
        >
          <Route path="/user/add-address" element={<Address></Address>}>
            {" "}
          </Route>
        </Route>
        ...
        >
          <Route path="/user/address/details" element={<ShowingAddress />}>
            {" "}
          </Route>
        </Route>
        ...
        >
          <Route path="/user/order/list" element={<OrderList></OrderList>}>
            {" "}
          </Route>
        </Route>
        ...
        >
          <Route
            path="/user/total-orders"
            element={<SellerSideOrderList></SellerSideOrderList>}
          >
            {" "}
          </Route>
        </Route> */}
        ...
        >
          <Route path="/admin/total-orders" element={<Orders></Orders>}>
            {" "}
          </Route>
        </Route>
        ...
        >
          <Route
            path="/admin/update-delivery-status/:oid"
