...
function Card({ data }) {
  ...
  return (
    <div onClick={() => navigate(`/details/${data._id}`)}>
      <div className="card w-60  bg-white shadow-xl h-[70vh]  flex flex-col  cursor-pointer overflow-hidden p-5 mt-1 mb-1 ">
        ...
        <div className="">
          ...
          <div className=" flex flex-row gap-2 items-center">
            <div className="text-white bg-[#45b06a] px-3 flex flex-row items-center gap-1 rounded-full">
              4.4 <FaStar className=" inline"></FaStar>
            </div>
