...
function OTP() {
    ...
    return (
        ...
        <div className="flex justify-center items-center bg-[#45b06a]">
            <form onSubmit={sendOTP} className="flex flex-col w-[400px] h-[60vh] bg-white shadow-lg shadow-cyan-500/50 p-10 gap-5 mt-10 mb-10">
            <div className="text-left text-2xl font-semibold">Email Verification</div>
            <div className="border border-[#45b06a]"></div>
                ...
                <button type="submit" className="btn btn-secondary mt-4">Send OTP</button>
            </form>
        </div>
        </HomeLayout>
    );
