...
function Signup() {
  ...
  {
    e.preventDefault();
  if([signupData.firstName ,signupData.lastName,signupData.confirmPassword ,signupData.email , signupData.role , signupData.password,signupData.phone_No,signupData.otp,signupData.profilePhoto].some((e)=>e===""))
    {
