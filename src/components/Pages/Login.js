  ...
  return (
    <div className="flex justify-center items-center bg-[#45b06a] h-[100vh]">
      <form
        ...
        className="flex flex-col w-[400px] h-[90vh] bg-white shadow-lg shadow-cyan-500/50 p-10 gap-5 mt-10 mb-10"
      >
        ...
        <div className="">
          Forgot Password
          {"   "}
          <Link to="/generate-token" className=" link-primary">
            Reset Password
          </Link>
        </div>
        <div className=" text-md ">
          ...
          <span>
            {" "}
            <Link className=" link-primary" to="/sendotp">
              Signup
            </Link>{" "}
          </span>
        </div>
