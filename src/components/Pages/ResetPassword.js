...
function ResetPassword()
{
    ...
    if(!newPass)
     ...
     try {
        //dispatch
        const response = await dispatch(passwordReset({token:token,newPass:newPass,confirmPass:confirmPass}));
...
return (
    ...
    <div className="flex justify-center items-center">
            <form onSubmit={resetPwd} className="flex flex-col w-[400px] h-[80vh] bg-yellow-200 shadow-lg shadow-cyan-500/50 p-10 gap-5 mt-10 mb-10">
