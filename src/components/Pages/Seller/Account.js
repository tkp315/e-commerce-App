...
<form onSubmit={accountCreation}  className="bg-yellow-500 flex flex-col gap-5 w-[500px] mt-10 p-10">
<div className="text-center text-3xl font-semibold ">Create Account</div>
