...
export default function OrderCard({product,seller,customer, payment,deilivery,address,orderid}) {
    ...
    <div className=' p-8'>
      <div className='flex flex-row w-full  min-h-[40vh] p-7 mt-1 mb-1 bg-white items-center border border-black gap-28'>
        ...
        <div className=' flex flex-row gap-4'>
          <div>
            <img
            src={product.thumbnail?product.thumbnail:"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS-gukc7EnLg2lXrV35IoDl3SrhFbupHeJhuw&s"} 
            className=' w-[100px]' 
            alt='pic'
            ></img>
          </div>
      ...
      <div className='  btn btn-success' onClick={btnHandler}>Update Status</div>
    </div>
