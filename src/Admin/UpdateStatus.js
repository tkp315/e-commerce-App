...
function UpdateStatus() {
  ...
  async function updateorderstatus(e) {
    ...
    const res = await dispatch(
      updateOrderDeliveryStatus({ orderId: oid, newStatus: newStatus })
    );
  ...
  return (
    <HomeLayout>
      <form
        ...
        className=" flex justify-center items-center min-h-[100vh] bg-[#45b06a]"
      >
        <div className="bg-white h-[50vh] w-[400px] p-5 flex flex-col gap-6">
          <h1 className="border-b border-[#45b06a]  text-xl font-semibold  pb-4 ">
          ...
          <div onClick={updateorderstatus} className=" btn ">
            Update
          </div>
        </div>
      </form>
