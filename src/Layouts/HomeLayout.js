            ...
            <div className="drawer z-20">
              ...
              <div className="drawer-content">
                ...
                <label htmlFor="my-drawer" className=" drawer-button">
                  <MdMenu className="text-3xl bg-transparent text-[#45b06a]  cursor-pointer"></MdMenu>
                </label>
              </div>
              <div className="drawer-side ">
                ...
                <ul className="menu p-4 w-80 min-h-full bg-base-200 text-base-content ">
                  ...
                  <li>
                    <Link to="/admin/total-orders">All Orders</Link>
                  </li>
                  {role === "Admin" ? (
                    <li>
                      <Link to="/admin/total-orders">All Orders</Link>
              ...
              >
                <div className="card-body">
                  ...
                  <div className="card-actions">
                    <Link to="/user/cart">
                      <button className="btn btn-primary text-[#45b06a] btn-block">
                        View cart
                      </button>
                    </Link>
                  </div>
              ...
              {isLoggedIn ? (
                <div className="dropdown dropdown-end">
                  ...
                  >
                    ...
                    <li>
                      <Link to={"/user/address/details"}>My Address</Link>
                    </li>
                ...
                <Link to="/login">
                  <button className="btn rounded-md h-2 w-14 p-4">Login</button>{" "}
                </Link>
              )}
            </div>
          </div>
